...
//console.log(d);
                   ...
                   if(d.length != 3) {
                     if( d[0] === connection.FHEM.alexa_device )
                       connection.FHEM.emit( 'RELOAD' );
...
FHEM.prototype.connect = function(callback) {
    //this.checkAndSetGenericDeviceType();
                    ...
                    function(result) {
                      try {
                        ...
                        if( d.totalResultsReturned === 1 ) {
                          this.alexa_device = d.Results[0].Name;
                          this.log.info( `alexa device is ${this.alexa_device}` );
                        } else
